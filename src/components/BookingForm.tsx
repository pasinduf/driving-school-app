    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 text-left">
      <div>
        ...
        <div className="flex flex-col space-y-2">
          <label className="flex items-center space-x-2">
            <input type="radio" value="myself" {...register("registerFor")} className="text-primary focus:ring-primary" />
            <span>Myself</span>
          </label>
          <label className="flex items-center space-x-2">
            <input type="radio" value="someone_else" {...register("registerFor")} className="text-primary focus:ring-primary" />
      ...
      <div className="border-t pt-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-gray-500 font-semibold uppercase text-sm tracking-wide">
            {registerFor === "myself" ? "Please provide your personal details" : "Please provide learner's personal details"}
          </h3>
          {registerFor === "myself" && (
            <label className="flex items-center space-x-2 bg-primary/10 px-3 py-1.5 rounded-lg border border-primary/20 cursor-pointer hover:bg-primary/20 transition-colors">
              <input type="checkbox" {...register("isExistingUser")} className="text-primary focus:ring-primary rounded h-4 w-4" />
              <span className="text-sm font-medium text-primary">I already have an account</span>
            </label>
          )}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {!(isExistingUser && registerFor === "myself") && (
            <>
              <div>
                <label className="block text-sm font-medium text-gray-700">
          ...
          {registerFor === "myself" && !isExistingUser && (
            <>
              <div>
                <label className="block text-sm font-medium text-gray-700">
              ...
              <div className="md:col-span-2">
                <span className="bg-primary/10 text-primary text-sm px-3 py-1.5 rounded-lg border border-primary/20 transition-colors">
          ...
          {registerFor === "myself" && isExistingUser && (
            <div className="md:col-span-2 mt-2">
              <p className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-200">
                You've selected that you already have an account. We will link this booking to your account using the email address provided above.
              </p>
            </div>
          )}
        </div>
      ...
      {registerFor !== "myself" && (
        <div className="border-t pt-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-gray-500 font-semibold uppercase text-sm tracking-wide">Please provide your details</h3>
            <label className="flex items-center space-x-2 bg-primary/10 px-3 py-1.5 rounded-lg border border-primary/20 cursor-pointer hover:bg-primary/20 transition-colors">
              <input type="checkbox" {...register("isExistingUser")} className="text-primary focus:ring-primary rounded h-4 w-4" />
              <span className="text-sm font-medium text-primary">I already have an account</span>
            </label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mt-5 py-1">
                {" "}
