            ...
            <div className="space-y-8">
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Booking Session Duration (Seconds)</label>
                            <input
                                type="number"
                            ...
                            />
                            <p className="text-xs text-gray-400 mt-2 font-light italic">
                                The locking duration for a booking session. Default is 180 seconds(3 Minutes).
                            </p>
                        </div>
                    </div>
                </div>
