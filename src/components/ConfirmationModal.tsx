                ...
                <div className="p-6 text-center">
                    ...
                    <div className="flex justify-center space-x-3">
                        ...
                        <button
                            ...
                            disabled={isConfirming}
                            className={
                                `px-4 py-2 text-white rounded-md transition-colors font-medium text-sm w-24 flex items-center justify-center ${variant === 'danger' ? 'bg-red-600 hover:bg-primary-700 disabled:bg-red-400' : 'bg-primary hover:bg-opacity-90 disabled:opacity-50'}`
                            }
                        >
                            {isConfirming ? (
